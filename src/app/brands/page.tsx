...
export default function Brands() {
  return (
    <div className="p-2.5 min-h-screen">
      <h1 className="text-2xl font-bold p-2.5">Top Brands</h1>
        ...
        {brands.map((brand) => (
          ...
          >
            <Link href={brand.href}>
              <div
                className="h-full p-5 rounded-2xl text-center text-xl font-medium 
                  bg-[#F7F7F7] dark:bg-[#1f1f23] border border-[#D8D9CF] dark:border-[#404258] 
                  hover:scale-102 transition space-y-5 flex flex-col justify-center items-center cursor-pointer"
              >
                <Image
                  src={brand.img}
                  alt={`${brand.name} logo`}
