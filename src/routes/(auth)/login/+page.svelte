	...
	<div class="flex w-full justify-center p-5">
		<div class="w-full max-w-md space-y-10">
			<div class="py-5 text-center">
				<a href="/" class="text-2xl font-bold md:text-4xl">Teker</a>
				<p class="pt-2.5 text-gray-600">Welcome! Login to continue</p>
			</div>

			<SocialAuthButton provider="google">Google</SocialAuthButton>

			<div class="relative">
				<hr class="border-[#393E46]" />
				<span
			...
			<form method="POST" class="space-y-5">
				<div
					class="flex items-center rounded-[10px] border border-[#393E46]
					bg-[#222831] px-5 py-2.5"
				>
			...
			<div class="space-y-2.5">
				<div class="text-center text-gray-600">
					<p>
						...
						<a href="/register" class="pl-2.5 hover:text-[#FF4F0F] hover:underline"> Register </a>
					</p>
				</div>
