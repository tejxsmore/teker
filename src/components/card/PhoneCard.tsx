...
export default function PhoneCard({ id, brand, name, price }: PhoneCardProps) {
    ...
    function handleAddToCart(id: number, brand: string, name: string, price: number) {
        addToCartStore({ name, brand, price });
        // toast.success(`${brand} ${name} added to cart`);
    }

    function handleBuy(id: number, brand: string, name: string, price: number) {
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between gap-5">
                <button
                    onClick={() => handleAddToCart(id, brand, name, price)}
                ...
                <button
                    onClick={() => handleBuy(id, brand, name, price)}
